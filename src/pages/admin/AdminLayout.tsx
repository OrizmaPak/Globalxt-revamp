          ...
          {user && isAllowed && (
            <div className="mx-auto max-w-6xl px-4 pb-3">
              <nav className="flex gap-4 text-sm">
                ...
                <NavLink to="/admin/stats" className={({ isActive }) => `px-3 py-1.5 rounded ${isActive ? 'bg-brand-primary text-white' : 'text-brand-deep hover:bg-brand-primary/10'}`}>Stats</NavLink>
              </nav>
            </div>
          )}
        </header>
